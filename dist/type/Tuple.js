...
var MaevaTypeTuple = function (_Type) {
  _inherits(MaevaTypeTuple, _Type);

  function MaevaTypeTuple() {
    _classCallCheck(this, MaevaTypeTuple);

    var _this = _possibleConstructorReturn(this, (MaevaTypeTuple.__proto__ || Object.getPrototypeOf(MaevaTypeTuple)).call(this));
  ...
  return MaevaTypeTuple;
}(_Type3.default);

exports.default = MaevaTypeTuple;