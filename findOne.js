...
var findOne = function findOne(model) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              _context.next = 10;
              return (0, _formatFindQuery2.default)(_query, model, options);

            case 10:
              query = _context.sent;
              _context.next = 13;
              return options.connection.connector.actions.findOne(query, model);
